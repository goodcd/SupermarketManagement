...
//		jLabel3.setFont(new java.awt.Font("宋体", Font.PLAIN, 20));	//设置字体
		...
		jButton1.addActionListener(new Administrator_jButton1_actionAdapter(this));		//注册监听器
		jButton2.setText("取    消");
		jButton2.setBounds(new Rectangle(210, 206, 83, 25));
		jButton2.addActionListener(new Administrator_jButton1_actionAdapter(this));		//注册监听器
